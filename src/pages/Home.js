      ...
      <section className="flex flex-col sm:flex-row sm:px-24 h-full px-6 sm:my-0 my-6">
        ...
        <div className="flex flex-col items-center gap-10 pt-8 sm:mt-0">
          ...
          <a
            href="/encuesta"
            type="button"
            className="hover:drop-shadow-[0_4px_80px_#5F6F94] flex w-80 items-center font-sans tracking-wide bg-gray-100 z-20 px-8 py-4 rounded-md sm:rounded-xl border border-gray-900"
          >
            <img
              ...
              alt="icon button"
            />
            <span className="text-center text-ec-blue text-xs sm:text-base font-montserrat font-bold">
