...
function Card() {
  return Videos.map((video) => {
    return (
      ...
      >
        <iframe
          className="hidden sm:flex w-full sm:w-64 h-40 rounded-t-lg"
          src={
            "https://www.youtube-nocookie.com/embed/" + video.url.substring(32)
          }
          loading="lazy"
        ...
        <div className="flex flex-col p-5 h-full justify-between items-center">
          ...
          <a
            ...
            className="flex justify-center items-center mt-4 py-3 px-6 text-xs font-sans font-medium text-center text-white bg-ec-blue rounded-lg hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-900 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Ver video
            <svg
              aria-hidden="true"
